...
dataset = "topsongsemanticmodel" # Enter the name or ID of the semantic model
workspace = "AllthingsCloud" # Enter the workspace name or ID in which the semantic model exists
